...
{
    public class TriangleFillTestGenerator : IGenerator
    {
        /* DI */
        private readonly IEngine _engine;

        /* Properties */
        public string Name => "Triangle Filling";

        public TriangleFillTestGenerator(IEngine engine)
        {
            this._engine = engine;
        }
        ...
        public IImage Generate()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                g.FillTriangle(first, second, third, RandomColor(rnd));
            }
