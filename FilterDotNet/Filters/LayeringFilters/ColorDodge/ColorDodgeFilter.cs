...
{
    public class ColorDodgeFilter : IFilter, IConfigurableFilter
    {
        /* DI */
        ...
        /* Properties */
        public string Name => "Color Dodge";

        public ColorDodgeFilter(IPluginConfigurator<IImage> pluginConfigurator, IEngine engine)
        {
        ...
        public IImage Apply(IImage input)
        {
            ...
            Parallel.For(0, input.Width, (int x) =>
            {
                Parallel.For(0, input.Height, (int y) =>
                {
                    ...
                    int nr = ColorDodgeClamp(oc.R, cc.R);
                    int ng = ColorDodgeClamp(oc.G, cc.G);
                    int nb = ColorDodgeClamp(oc.B, cc.B);
